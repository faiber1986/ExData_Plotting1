setwd("C:/Users/andre/Desktop/CURSO DATA SCIENCE JH/Exploratory Data Analisys")

# Read and load file into a data table subseting by date 1/2/2017 - 2/2/2017
Data <- read.table("C:/Users/andre/Desktop/CURSO DATA SCIENCE JH/Exploratory Data Analisys/household_power_consumption.txt", header = TRUE, sep = ";")
